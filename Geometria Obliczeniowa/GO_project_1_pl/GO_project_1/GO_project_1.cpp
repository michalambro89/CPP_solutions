...
int main() {
    ...
    std::cout << std::fixed << std::setprecision(16) << "Result of vector product: " << product_result << std::endl;
    std::cout << std::fixed << std::setprecision(16) << "Sarrus method result: " << sarrus_result << std::endl;
    ...
    std::cout << std::fixed << std::setprecision(16) << "Score difference: " << difference() << std::endl;
